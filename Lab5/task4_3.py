...
def load_textures(textureSurface):
...
def image_preprocessor(*img):
    ...
    surface = pygame.surface.Surface((sum(i.get_width() for i in images), images[0].get_height()), HWSURFACE)
    x_offset = 0
    for image in images:
        surface.blit(image, (x_offset, 0))
...
if __name__ == '__main__':
    ...
    display = (800, 600)
    # OnCreate
    pg.display.set_mode(display, DOUBLEBUF | OPENGL | RESIZABLE | HWSURFACE)
    ...
    angle = 0
    # -------------------
    textures = image_preprocessor('1.jpg', '2.jpg', '3.jpg', '4.jpg')
